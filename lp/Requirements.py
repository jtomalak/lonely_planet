...
# This module is a kludge since neither the required CSS file, nor
# the template file we use are passed as parameters, so we generate our
# own!
...
<html>
    ...
    <body>
        <div id="container">
            <div id="header">
                <div id="logo"></div>
                <h1>Lonely Planet: {{ destination_name }}</h1>
            </div>
            ...
            <div id="main">
                <div class="block">
                    <div class="secondary-navigation">
                        <ul>
                            <li class="first"><a href="#">{{ destination_name }}</a></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                    <div class="content">
                        <div class="inner">
                        {% for item_title, item_contents in destination_content.iteritems() %}
                            <h2>{{ item_title }}</h2>
...
def create_css_file(output_directory):
    with open(output_directory + '/all.css', 'w') as css_file: #overwrite!
        css_file.write("""\
* {margin:0;padding:0}
